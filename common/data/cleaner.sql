...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2017 at 10:25 AM
...
INSERT INTO `ad_pool` (`id`, `cleaner_user_id`, `ad_place_id`, `subscription_id`, `status`) VALUES
(1, 32, 1, 1, 0);
...
INSERT INTO `job` (`id`, `customer_user_id`, `region_id`, `category_id`, `title`, `price`, `status`, `contact_no`, `description`, `address`, `timestamp`, `date`, `longitude`, `latitude`) VALUES
(3, 24, 1, 1, 'hello', 1200, 2, NULL, 'Hleoo', 'hi', '2017-03-14 09:11:19', '2017-04-18', 0, 0),
(13, 24, 3, 3, 'Clean my gutter', 12000, 1, '0090900229', '', 'eee', '2017-04-04 12:25:39', '2017-04-18', 0, 0),
(18, 24, 1, 3, 'Clean my gutter', 12000, 1, '0090900229', '', 'eee', '2017-04-04 12:34:29', '2017-04-18', 0, 0),
(19, 24, 1, 3, 'Clean my gutter', 12000, 1, '0090900229', '', 'eee', '2017-04-04 12:34:48', '2017-12-12', 0, 0),
(20, 24, 3, 2, 'Clean our home', 12000, 1, '00903433343', 'Please do it.', '', '2017-04-05 05:25:48', '2017-12-12', 0, 0),
(21, 24, 2, 1, 'Clean my gutter', 12999, NULL, '00989929929', 'Hello', 'Block 4-E', '2017-04-05 12:44:45', '2017-04-06', 0, 0),
(22, 26, 1, 1, 'Garden cleaning', 1200, 1, '5433735', 'Hello there is lot of waste near the garden so want to it clean.', 'Defence phase 3', '2017-04-07 10:20:44', '2017-04-10', 0, 0),
(23, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 13:53:15', '2017-04-12', 0, 0),
(24, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 13:58:24', '2017-04-12', 0, 0),
(25, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 14:05:43', '2017-04-12', 0, 0),
(26, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 14:07:03', '2017-04-12', 0, 0),
(27, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 14:11:54', '2017-04-12', 0, 0),
(28, 26, 2, 3, 'fdgdfs', 446, 10, 'adgg', 'erwy', 'wywyw', '2017-04-17 14:19:44', '2017-04-12', 0, 0),
(29, 33, 2, 1, 'Park cleaning', 12000, 10, '5737353573', 'this is park cleaning job', 'Islamabad', '2017-04-21 05:40:29', '2017-04-19', 0, 0),
(30, 33, 3, 1, 'this is title', 4524, 10, '4662', 'this is discription', 'Islamabad', '2017-04-21 12:15:23', '2017-04-26', NULL, NULL),
(31, 33, 3, 1, 'this is title', 3523, 10, '536454', 'this is discription', 'Islamabad', '2017-04-21 12:17:32', '2017-04-11', NULL, NULL),
(32, 33, 1, 1, 'this is title', 322, 10, '4662', 'thhhhh', 'karachi', '2017-04-21 12:27:11', '2017-04-25', NULL, NULL),
(33, 33, 1, 1, '', NULL, NULL, 'dfdf', '', '', '2017-04-21 14:34:40', NULL, 666.99, 778878),
(34, 33, 5, 1, 'this is another title', 675665, 10, '67458484', 'this is another discription', 'karachi', '2017-04-24 06:33:18', NULL, 5.5635, 56.5463),
(35, 35, 6, 1, 'gilgat project', 34590, 10, '352326', 'this is gilgat project', 'gilgat', '2017-04-24 07:33:09', NULL, 34.3523, 343.34343);
...
(26, 'wajid khan', 'wajid', 'khan', '578893', 'B0mvcGnZ--nTjByxrYHWaYsKzJoqbpOW', '$2y$13$bGUApbFCL7SiGSq0eALVuu4z0cjwB2SgqkWr9IOxXPZchbU2YHWHy', NULL, 'waji@gmail.com', NULL, 'karachi', 10, NULL, NULL, 10, 1491476243, 1493014997),
...
--
ALTER TABLE `ad_pool`
  ADD CONSTRAINT `fk_add_pool_ad_place1` FOREIGN KEY (`ad_place_id`) REFERENCES `ad_place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_add_pool_cleaner1` FOREIGN KEY (`cleaner_user_id`) REFERENCES `cleaner` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
